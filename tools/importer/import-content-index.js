...
// PAGE TEMPLATE CONFIGURATION - Embedded from page-templates.json (content-index)
const PAGE_TEMPLATE = {
  name: 'content-index',
  ...
  sections: [
    {
      id: 'rc1', name: 'Blog hero intro', selector: '#main-content > header.section.secondary-section', style: 'grey', blocks: [], defaultContent: ['#main-content > header.section.secondary-section .grid-layout'],
    },
    {
      id: 'rc2', name: 'Featured article teaser', selector: '#main-content > section.section:nth-of-type(1)', style: null, blocks: ['columns'], defaultContent: [],
    },
    {
      id: 'rc3', name: 'Latest articles', selector: '#articles', style: 'grey', blocks: ['cards'], defaultContent: ['#articles > div.container > div.utility-text-align-center'],
    },
    {
